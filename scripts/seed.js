...
const samplePlayers = [
  {
    ...
    twitch: 'humzh',
    description: 'Main champions: Darius, Renekton, Mordekaiser',
    record: '2-1',
    points: 350,
  },
  {
    ...
    twitch: 'alois_nl',
    description: 'Main champions: Darius, Camille, Sett',
    record: '1-0',
    points: 300,
  },
  {
    ...
    twitch: 'drututt',
    description: 'Main champions: Camille, Fiora, Irelia',
    record: '1-1',
    points: 250,
  },
  {
    ...
    twitch: 'tfblade',
    description: 'Main champions: Jax, Irelia, Akali',
    record: '0-2',
    points: 220,
  },
  {
    ...
    title: 'Ex-Fnatic Mid',
    twitch: 'nemesis_lol',
    description: 'Main champions: Twisted Fate, Orianna, Syndra',
    record: '0-1',
    points: 200,
  },
  {
    ...
    twitch: 'solarbacca',
    description: 'Main champions: Shen, Ornn, Malphite',
    record: '0-1',
    points: 180,
  },
  {
    ...
    title: 'Jungle Main',
    twitch: 'agurin',
    description: 'Main champions: Graves, Nidalee, Kha\'Zix',
    record: '0-1',
    points: 150,
  },
  {
    ...
    title: 'Riven God',
    twitch: 'adrianaries',
    description: 'Main champions: Riven, Fiora, Yasuo',
    record: '0-1',
    points: 120,
  },
];
